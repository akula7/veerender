...
public class Testngmaster
{
	...
	{
		fi=new FileInputStream("C:\\Users\\veerender\\workspace\\Stockaccounting\\src\\com\\stockacc\\properties\\stockaccoutingLocatervalues.properties");
		pr=new Properties();
		pr.load(fi);
		expval="btnsubmit";
		...
		{
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\veerender\\Downloads\\chromedriver.exe");
			driver=new ChromeDriver();
		}
		else if (br.equalsIgnoreCase("ie")) 
		{
			System.setProperty("webdriver.ie.driver", "C:\\Users\\veerender\\Downloads\\IEDriverServer.exe");
